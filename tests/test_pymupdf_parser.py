...
@pytest.fixture(
    params=[
        ...
        {
            "id": "PMC12231352",
            "expected_abstract": "1School of Clinical Medical, Hubei University of Chinese Medicine, Wuhan, China, 2Department of Gastroenterology, Hubei Provincial Hospital of Integrated Chinese and Western Medicine, Wuhan, China, 3Department of Health Management Center, Hubei Provincial Hospital of Traditional Chinese Medicine, Wuhan, China\n"
    ...
    params=[
        {
            "id": "PMC12416454",
            "figure_descriptions": [
                "Figure 1. Coordination-driven self-assembly of L into stellated helical octahedral Pd6L8 and cuboctahedral Pd12L16 SCCs and their transformation reactions: a) using [Pd(ACN)4](BF4)2, b) using Pd(NO3)2. The blue asterisk denotes chiral centres of the steroid skeleton.",
